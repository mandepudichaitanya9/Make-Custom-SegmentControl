...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    private lazy var defaultSegments: [BetterSegmentedControlSegment] = {
        return [LabelSegment(text: "Weekly"), LabelSegment(text: "Monthly"), LabelSegment(text: "Yearly")]
    }()
    ...
    required public init?(coder aDecoder: NSCoder) {
        self.index = 0
        self.segments = [LabelSegment(text: "Weekly"), LabelSegment(text: "Monthly"), LabelSegment(text: "Yearly")]
        super.init(coder: aDecoder)
        completeInit()
    }
    ...
    convenience override public init(frame: CGRect) {
        self.init(frame: frame,
                  segments: [LabelSegment(text: "Weekly"), LabelSegment(text: "Monthly"), LabelSegment(text: "Yearly")])
    }
